...
csv_Job_Orders = 'C:\\Users\\wyllierosi\\Documents\\504\\grab-and-go-admin\\back-end\\Orders.txt'
...
def readOrders():
    with open(csv_Job_Orders, 'r') as csv_file:
        ...
        for order in csv_reader:
            ...
            companyId = int(0)
            for all in companyIdResults: 
                print(all)
                companyIdresult = companyIdResults[0]
                companyId = companyIdresult[0]
                print(companyId)
            ...
            #Surf Lifesaving Kits,65 piece First Aid,Waterproof Plus - Plain ,Premium First Aid Kit,Compact First Aid Kits,Solar Lanterns,Waterproof Solar Torch,Powerbank 10000,Powerbank 15000,KN95 Masks,Gloves
            productList = ["1 Person Emergency Kit", "4 person Duffles", "Dynamo Torches", "Surf Lifesaving Kits", "65 piece First Aid", "Waterproof Plus - Plain", "Premium First Aid Kit", "Compact First Aid Kits", "Solar Lanterns", "Waterproof Solar Torch", "Powerbank 10000", "Powerbank 15000", "KN95 Masks", "Gloves"]
            for product in productList:
                ...
                if product in order and order[product]:
                    ...
                    valuesToInsert = (job_order, productIdInt, productQuantity, priceInt)
            ...
            valuesForOrders = (job_order, POnumber, generatedInt, date, 0.00, BarlowsInvoice, Delivered, Invoiced, Paid)
